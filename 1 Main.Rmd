...
rm(list=ls())
wd            <- "C:/Users/87375emi/OneDrive - Erasmus University Rotterdam/Documents/Thesis/Reports and documentation/End Presentation/Submission/Preventative Medicine/Paper/"
library("pacman")
...
png(file = paste(wd,"/Scenarios_results_DMprev_ATTICA_Adjusted",plotsex,".png",sep=""),width = 8, height = 10, units = "in", res = 96)
#setEPS()
#postscript(paste(wd,"/Scenarios_results_Female.eps",sep=""),width = 10, height = 12)
...
#plot.new()
#legend("center",legend=c("-10%","-50%","-100%"), title = "Legend \nReduction of \nprevalence (a)")
...
```{r Prevalence - conditional on survival}
names.plots.figure <- c("Childhood \nScenario","Adulthood \nScenario","Combination \nScenario")
v_ylim <- c(80,50) 
v_what <- c(5,1)
plotsex <- "Male"
...
png(file = paste(wd,"/Scenarios_results_DMprevalive_ATTICA_",plotsex,".png",sep=""),width = 8, height = 10, units = "in", res = 96)
#setEPS()
#postscript(paste(wd,"/Scenarios_results_Female.eps",sep=""),width = 10, height = 12)
